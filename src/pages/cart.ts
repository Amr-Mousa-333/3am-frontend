...
export class CartPage extends View<"div"> {
  ...
  render(): DocumentFragment {
    const totalPrice = "84995.00";  // Hardcoded for demo purposes, in real app this would come from cart state or API
    const gPayButton = new GooglePayButton(totalPrice);
    return this.tpl`
      ...
      <aside class="cart-summary">
        ...
        <div class="google-pay-container">
          ${gPayButton}
          <p class="secure-text">Secure Encrypted Checkout using Google Pay</p>
        </div>
      </aside>
    `;
  }
